...
{{/* The used web context determined by explicit value or from the path as fallback */}}
{{- define "keycloak.webContext" -}}
{{ .Values.env.webContext | default (print (.Values.ingress.path | trimSuffix "/") "/auth") }}
{{- end -}}
